...
import com.libs.libvlc.LibVLC;
import com.libs.libvlc.Media;
...
public class MediaPlayer {
    ...
    private com.libs.libvlc.MediaPlayer mMediaPlayer;

    public MediaPlayer() {
        mLibVLC = new LibVLC(null); //FIXME, this is wrong
        mMediaPlayer = new com.libs.libvlc.MediaPlayer(mLibVLC);
    }
